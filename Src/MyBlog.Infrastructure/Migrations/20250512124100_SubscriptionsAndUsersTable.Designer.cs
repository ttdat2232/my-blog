...
namespace MyBlog.Infrastructure.Migrations
{
    ...
    [Migration("20250512124100_SubscriptionsAndUsersTable")]
    partial class SubscriptionsAndUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Core.Aggregates.Users.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 5, 12, 12, 40, 59, 688, DateTimeKind.Utc).AddTicks(743))
                        .HasColumnName("created_at");

                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 5, 12, 12, 40, 59, 688, DateTimeKind.Utc).AddTicks(1800))
                        .HasColumnName("updated_at");
