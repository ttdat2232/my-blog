...
namespace MyBlog.Postgres.Migrations
{
    ...
    [Migration("20250516044013_AddUsersAndUserRolesTable")]
    partial class AddUsersAndUserRolesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Core.Aggregates.Users.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 5, 16, 4, 40, 12, 265, DateTimeKind.Utc).AddTicks(296))
                        .HasColumnName("created_at");

                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 5, 16, 4, 40, 12, 265, DateTimeKind.Utc).AddTicks(1413))
                        .HasColumnName("updated_at");
