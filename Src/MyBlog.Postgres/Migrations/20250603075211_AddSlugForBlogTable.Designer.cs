...
namespace MyBlog.Postgres.Migrations
{
    ...
    [Migration("20250603075211_AddSlugForBlogTable")]
    partial class AddSlugForBlogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Core.Aggregates.Users.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 6, 3, 7, 52, 8, 592, DateTimeKind.Utc).AddTicks(5465))
                        .HasColumnName("created_at");

                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 6, 3, 7, 52, 8, 592, DateTimeKind.Utc).AddTicks(6772))
                        .HasColumnName("updated_at");
