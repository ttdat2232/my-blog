...
namespace MyBlog.Postgres.Migrations
{
    ...
    [Migration("20250601084150_ConfigureCommentsTable")]
    partial class ConfigureCommentsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Core.Aggregates.Users.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 6, 1, 8, 41, 49, 892, DateTimeKind.Utc).AddTicks(8204))
                        .HasColumnName("created_at");

                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 6, 1, 8, 41, 49, 892, DateTimeKind.Utc).AddTicks(9629))
                        .HasColumnName("updated_at");
